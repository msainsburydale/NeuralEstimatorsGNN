...
ggsave(figure, file = "spatialpatterns.pdf", width = 7.3, height = 4.7, path = "img", device = "pdf")
...
ggsave(figure, file = "spatialpatternsII.pdf", width = 7.3, height = 2.4, path = "img", device = "pdf")
