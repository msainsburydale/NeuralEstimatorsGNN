...
intervalestimator = IntervalEstimatorCompactPrior(U, V)
...
# TODO conditional coverage: coverage given specific parameter values

# In addition to overall coverage, check that central credible intervals are
...
#NB m should be an argument of this function, as should simulator
# """
...
# 		intervals = interval(estimator, Z)
